...
def build_driver():
    global driver
    url = f'https://browse.auction.co.kr/search?keyword={keyword[count]}&itemno=&nickname=&frm=hometab&dom=auction&isSuggestion=No&retry=&=&s=3&k=0&p={pageList[-1]}'
